...
#define LEDs_NUM (6)
static struct timer_list led_blink_ctl_timer[LEDs_NUM];
static u8 blink_led_status[]={0,0,0,0,0,0};
static u8 blink_led_speed[]={0,0,0,0,0,0};
#endif
...
#ifdef CONFIG_LEDS_ZTE
static void pmic8058_led_blink_set(struct led_classdev *led_cdev,
