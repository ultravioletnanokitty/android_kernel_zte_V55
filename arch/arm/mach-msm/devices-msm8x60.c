...
struct clk_lookup msm_clocks_8x60[] = {
	...
	CLK_8X60("gsbi_uart_clk",	GSBI12_UART_CLK, "msm_serial_hsl.0",
			OFF),
	CLK_8X60("gsbi_qup_clk",	GSBI1_QUP_CLK, "qup_i2c.9", OFF),
	...
	CLK_8X60("gsbi_pclk",		GSBI1_P_CLK, "qup_i2c.9", OFF),
	...
	CLK_8X60("csi_vfe_clk",		CSI1_VFE_CLK,	  "msm_camera_ov9726.0",
			OFF),
#ifdef CONFIG_CAMERA_MT9D115_ZTE
	CLK_8X60("csi_vfe_clk",		CSI1_VFE_CLK,	  "msm_camera_mt9d115.0", OFF),
#endif
