...
static struct gpiomux_setting wb_active_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
};
...
static struct gpiomux_setting chg_gpio_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
};
...
static struct gpiomux_setting attiny44a_pm_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_UP,
};
...
#ifdef CONFIG_MAX8903_CHARGER
static struct msm_gpiomux_config msm8x60_chg_configs[] __initdata = {
	/* CHARGER_CEN_N */
	{
		.gpio = 102,
		.settings = {
